...
public class AccountUpdateClaimantDetailsV7Impl implements AccountUpdateClaimantDetails
    <V4UpdateClaimantDetailsRequest, ResponseEntity<V7AccountDetails>> {
  ...
  public AccountUpdateClaimantDetailsV7Impl(ClaimantService claimantSvc,
  ...
  @Override
  public ResponseEntity<V7AccountDetails>
    ...
    return ResponseEntity.accepted().body(dataMapper.mapToV7AccountDetails(claimant));
  }
}
