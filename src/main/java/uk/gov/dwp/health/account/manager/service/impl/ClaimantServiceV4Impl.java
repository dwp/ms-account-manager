...
@Slf4j
@Service
public class ClaimantServiceV4Impl implements ClaimantService<V4NewAccountRequest> {
  ...
  @Override
  public String createAccount(final V4NewAccountRequest request) {
