...
@Slf4j
public class AccountCreateV3Impl
    implements AccountCreate<V3NewAccountRequest, ResponseEntity<AccountReturn>> {

  private final ClaimantService claimantService;

  public AccountCreateV3Impl(
      ClaimantService claimantService) {
    this.claimantService = claimantService;
  }

  @Override
  public ResponseEntity<AccountReturn> doCreateAccount(V3NewAccountRequest request) {
