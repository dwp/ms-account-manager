...
public class CreateAccountRequest {
    private static final String[] userJourneys = {"TACTICAL", "STRATEGIC" };
    ...
    @Default
    private String researchContact = "Yes";
    @Default
    ...
    @Default
    private String userJourney = userJourneys[faker().random().nextInt(userJourneys.length)];
