...
import static uk.gov.dwp.health.account.manager.utils.UrlBuilderUtil.patchClaimantDetailsV7Url;
import static uk.gov.dwp.health.account.manager.utils.UrlBuilderUtil.postAccountV7Url;

class PatchClaimantDetailsV7IT extends ApiTest {
  ...
  void shouldReturn202StatusCodeForClaimantDetailsPatchUpdate() {
    ...
    Response response = patchRequest(patchClaimantDetailsV7Url(), updateAccountRequest);
  ...
  void shouldReturn409StatusCodeForExistingEmailPatchUpdate() {
    ...
    AccountCreationResponse accountCreationResponse =
        postRequest(postAccountV7Url(), createSecondAccountRequest).as(AccountCreationResponse.class);
