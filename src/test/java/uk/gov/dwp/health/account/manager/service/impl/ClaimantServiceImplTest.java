...
class ClaimantServiceImplTest {

  @InjectMocks private ClaimantServiceImpl underTest;
  ...
  void testNormalizeInputWhenFindingAccountDetails() {
    ...
    Optional<Claimant> actual =
        underTest.findAccountBy("citizen@dwp.gov.uk", "RN000065b", LocalDate.of(1993, 8, 10));
    assertThat(actual).isEmpty();
    verify(repository)
        .findByEmailAddressAndNinoAndDateOfBirth(
            "citizen@dwp.gov.uk", "RN000065B", LocalDate.of(1993, 8, 10));
  }
  ...
  void testCreateAccountWithGivenDetails() {
    ...
    verify(repository)
        .findByEmailAddressAndNinoAndDateOfBirth(
            "citizen@dwp.gov.uk", "RN000065B", LocalDate.of(1990, 9, 10));
