...
import static uk.gov.dwp.health.account.manager.openapi.model.V4NewAccountRequest.LanguageEnum.EN;
import static uk.gov.dwp.health.account.manager.openapi.model.V4NewAccountRequest.UserJourneyEnum.TACTICAL;

@ExtendWith(MockitoExtension.class)
class AccountCreateV4ImplTest {

  @InjectMocks private AccountCreateV4Impl cut;
  ...
  @Test
  @DisplayName("test returns 201 and new account ref")
  void testReturns201AndNewAccountRef() {
    ...
    request.researchContact(V4NewAccountRequest.ResearchContactEnum.YES);
    ...
    var actual = cut.doCreateAccount(request);
    ...
    assertAll(
        ...
        () -> {
          ...
          assertThat(claimant.getResearchContact()).isEqualTo(ResearchContact.Yes);
        });
