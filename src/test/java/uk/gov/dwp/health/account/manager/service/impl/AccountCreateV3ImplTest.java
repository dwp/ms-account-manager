...
import static uk.gov.dwp.health.account.manager.openapi.model.V3NewAccountRequest.LanguageEnum.EN;
import static uk.gov.dwp.health.account.manager.openapi.model.V3NewAccountRequest.UserJourneyEnum.TACTICAL;

@ExtendWith(MockitoExtension.class)
class AccountCreateV3ImplTest {

  @InjectMocks private AccountCreateV3Impl cut;
  ...
  void testReturns201AndNewAccountRef() {
    var request = new V3NewAccountRequest();
