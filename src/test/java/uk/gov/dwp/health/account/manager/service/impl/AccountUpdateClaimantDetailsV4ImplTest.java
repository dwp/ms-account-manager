...
class AccountUpdateClaimantDetailsV4ImplTest {

  private AccountUpdateClaimantDetailsV4Impl cut;
  ...
  void setup() {
    ...
    cut = new AccountUpdateClaimantDetailsV4Impl(claimantService, dataMapper, updateEmailImpl, updateNinoImpl);
  }
  ...
  void testUpdateAccountClaimantDetails() {
    ...
    order.verify(dataMapper).mapToV4AccountDetails(claimantCaptor.capture());
